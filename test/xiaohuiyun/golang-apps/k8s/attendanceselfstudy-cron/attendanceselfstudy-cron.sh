...
serviceName="attendanceselfstudy-cron"
fileName="attendanceselfstudy.go"
servicePath="src/epoch/app/ujy/module/attendanceselfstudy/cmd/cron"
...
echo "----------------------------k8s部署状态-----------------------------"
kubectl get cronjob -n $namespace -o wide | grep $serviceName
