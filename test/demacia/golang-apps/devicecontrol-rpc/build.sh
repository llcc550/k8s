...
serviceName="devicecontrol-rpc"
fileName="devicecontrol.go"
servicePath="src/demacia/cloudscreen/devicecontrol/rpc"
...
# 复制配置文件
/bin/cp -f $configFileDir/demacia/golang-apps/rpc.yaml config.yaml
