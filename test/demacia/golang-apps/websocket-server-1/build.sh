...
serviceName="websocket-server-1"
fileName="websocket.go"
servicePath="src/demacia/service/websocket/server"
...
# 复制配置文件
/bin/cp -f $configFileDir/demacia/golang-apps/$serviceName/config.yaml config.yaml
